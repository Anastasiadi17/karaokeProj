...
4. Подвигать ползунок подпевки: терция с квинтой должны звучать как второй
   ...
   делает ни один тест.
5. Нажать «Измерить задержку» через динамики — число должно оказаться
   близко к тому, что подобрано на слух. В наушниках та же кнопка обязана
   честно сказать, что щелчок не вернулся.
6. Подвигать ползунок смещения и слушать заново — сдвиг слышен в обе стороны.
...
7. Обновить страницу с записанным дублем: браузер предупреждает, а после
   перезагрузки дубль возвращается из IndexedDB — его можно слушать и
   скачивать, не перепевая.
